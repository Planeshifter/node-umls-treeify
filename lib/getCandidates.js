(function() {
  ...
  getCandidates = function(docs) {
    ...
    fMappingCandidates = BPromise.join(fNetwork, fMappingCandidates, (function(_this) {
      return function(network, candidates) {
        var ret;
        ret = candidates.map(function(doc, i) {
